...
var Rabbit = jajom.Object.extend({
	...
	constructor: function (options) {
		...
		this.set('storage', require('./storage/localStorage').getInstance().serve)

		this.set('routes', require('./routes'))
		this.set('error handler', require('./errors'))
  ...
  // Create the server, setting up the express app
	createServer: function () { 
		...
		if('function' === typeof this.get('error handler'))
			this.get('error handler')(this.app)
